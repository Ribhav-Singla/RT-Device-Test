...
exports.authRouter.post('/signin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //@ts-ignore
        const token = jsonwebtoken_1.default.sign({ id: admin._id, isAdmin: true }, process.env.JWT_SECRET);
        res.status(200).json({
            token: token
        });
    }
...
exports.authRouter.post('/userLogin/:id', admin_1.adminAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
